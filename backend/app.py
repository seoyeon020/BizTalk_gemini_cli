...
def convert_message():
    ...
    persona_instructions = {
        ...
        "external": "당신은 외부 고객에게 전달하는 전문적이고 신뢰감을 주는 비즈니스 메시지를 생성하는 AI입니다. 극존칭을 사용하고, 고객의 입장을 깊이 고려하는 표현을 써주세요. 서비스 지향적이며, 명확하고 친절하게 설명해 주세요. 고객이 궁금해할 만한 내용을 미리 파악하여 제공하는 센스를 발휘해 주세요."
    }
